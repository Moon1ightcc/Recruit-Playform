    ...
    <div class="form-wrap clearfix">
      ...
      <el-col :span="16">
        ...
        >
          ...
          <el-form-item label="公司名称" prop="user.companyName">
            <el-input
              v-model="formData.user.companyName"
              placeholder="请输入公司名称"
              :maxlength="20"
              show-word-limit
              clearable
          ...
          <el-form-item label="公司地址" prop="user.companyAddress">
            <el-input
              v-model="formData.user.companyAddress"
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="企业性质" prop="user.nature">
                <el-select
                  v-model="formData.user.nature"
                  placeholder="请选择企业性质"
                  clearable
                  :style="{ width: '100%' }"
                >
          ...
          <el-form-item label="企业描述" prop="user.remark">
            <el-input
...
import { registerComapny,  getRequestPermissionCode,
  sendEmailCode, } from "@/api/recruit/register";
export default {
  ...
  methods: {
    ...
    submitForm() {
      this.$refs["elForm"].validate((valid) => {
        if (valid) {
          registerComapny(this.formData.user).then((response) => {
